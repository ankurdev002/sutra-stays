              ...
              {sutraFootprints.map((item) => (
                <div key={item.title} className="flex flex-col gap-3.5">
                  ...
                  <div className="rounded-3xl overflow-hidden bg-off-white-3 w-full h-fit py-3.5 pl-5.5 pr-2">
                    <div>
                      {/* <p className="text-black text-[40px] leading-10 font-bold font-plus-jakarta-sans capitalize">
                        {item.number}+
                      </p> */}
                      <h4 className="text-charcoal-light-gray-5 text-sm  font-inter leading-4 font-bold">
                        {item.title}
                      </h4>
                    </div>
                  </div>
